...
from scp_socp_solver import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    upd = cpg_module.scp_socp__cpg_updated()
    if updated_params is None:
        updated_params = ["param15", "param16", "param17", "param7", "param18", "param20", "param8", "param19", "param21", "param9", "param10", "param11", "param12", "param13", "param14"]
    ...
    par = cpg_module.scp_socp__cpg_params()
    ...
    par.param20 = squeeze_scalar(param_dict["param20"].value)
    par.param8 = list(param_dict["param8"].value.flatten(order="F"))
    par.param19 = squeeze_scalar(param_dict["param19"].value)
    par.param21 = squeeze_scalar(param_dict["param21"].value)
    ...
    prob.var_dict['var4'].save_value(np.array(res.cpg_prim.var4).reshape((14, 29), order='F'))
    prob.var_dict['var5'].save_value(np.array(res.cpg_prim.var5).reshape((30, 1), order='F'))
    prob.var_dict['var6'].save_value(np.array(res.cpg_prim.var6))
    prob.var_dict['var1'].save_value(np.array(res.cpg_prim.var1).reshape((14, 30), order='F'))
    prob.var_dict['var2'].save_value(np.array(res.cpg_prim.var2).reshape((3, 30), order='F'))
    prob.constraints[0].save_dual_value(np.array(res.cpg_dual.d0).reshape(30))
    ...
    prob.constraints[10].save_dual_value(np.array(res.cpg_dual.d10).reshape((1, 1), order='F'))
    prob.constraints[11].save_dual_value(np.array(res.cpg_dual.d11).reshape(1))
    prob.constraints[12].save_dual_value(np.array(res.cpg_dual.d12).reshape(1))
    ...
    prob.constraints[18].save_dual_value(np.array(res.cpg_dual.d18).reshape((1, 1), order='F'))
    prob.constraints[19].save_dual_value(np.array(res.cpg_dual.d19).reshape(1))
    prob.constraints[20].save_dual_value(np.array(res.cpg_dual.d20).reshape(1))
    ...
    prob.constraints[26].save_dual_value(np.array(res.cpg_dual.d26).reshape((1, 1), order='F'))
    prob.constraints[27].save_dual_value(np.array(res.cpg_dual.d27).reshape(1))
    prob.constraints[28].save_dual_value(np.array(res.cpg_dual.d28).reshape(1))
    ...
    prob.constraints[34].save_dual_value(np.array(res.cpg_dual.d34).reshape((1, 1), order='F'))
    prob.constraints[35].save_dual_value(np.array(res.cpg_dual.d35).reshape(1))
    prob.constraints[36].save_dual_value(np.array(res.cpg_dual.d36).reshape(1))
    ...
    prob.constraints[42].save_dual_value(np.array(res.cpg_dual.d42).reshape((1, 1), order='F'))
    prob.constraints[43].save_dual_value(np.array(res.cpg_dual.d43).reshape(1))
    prob.constraints[44].save_dual_value(np.array(res.cpg_dual.d44).reshape(1))
    ...
    prob.constraints[50].save_dual_value(np.array(res.cpg_dual.d50).reshape((1, 1), order='F'))
    prob.constraints[51].save_dual_value(np.array(res.cpg_dual.d51).reshape(1))
    prob.constraints[52].save_dual_value(np.array(res.cpg_dual.d52).reshape(1))
    ...
    prob.constraints[58].save_dual_value(np.array(res.cpg_dual.d58).reshape((1, 1), order='F'))
    prob.constraints[59].save_dual_value(np.array(res.cpg_dual.d59).reshape(1))
    prob.constraints[60].save_dual_value(np.array(res.cpg_dual.d60).reshape(1))
    ...
    prob.constraints[66].save_dual_value(np.array(res.cpg_dual.d66).reshape((1, 1), order='F'))
    prob.constraints[67].save_dual_value(np.array(res.cpg_dual.d67).reshape(1))
    prob.constraints[68].save_dual_value(np.array(res.cpg_dual.d68).reshape(1))
    ...
    prob.constraints[74].save_dual_value(np.array(res.cpg_dual.d74).reshape((1, 1), order='F'))
    prob.constraints[75].save_dual_value(np.array(res.cpg_dual.d75).reshape(1))
    prob.constraints[76].save_dual_value(np.array(res.cpg_dual.d76).reshape(1))
    ...
    prob.constraints[82].save_dual_value(np.array(res.cpg_dual.d82).reshape((1, 1), order='F'))
    prob.constraints[83].save_dual_value(np.array(res.cpg_dual.d83).reshape(1))
    prob.constraints[84].save_dual_value(np.array(res.cpg_dual.d84).reshape(1))
    ...
    prob.constraints[90].save_dual_value(np.array(res.cpg_dual.d90).reshape((1, 1), order='F'))
    prob.constraints[91].save_dual_value(np.array(res.cpg_dual.d91).reshape(1))
    prob.constraints[92].save_dual_value(np.array(res.cpg_dual.d92).reshape(1))
    ...
    prob.constraints[100].save_dual_value(np.array(res.cpg_dual.d100).reshape(1))
    ...
    prob.constraints[108].save_dual_value(np.array(res.cpg_dual.d108).reshape(1))
    ...
    prob.constraints[116].save_dual_value(np.array(res.cpg_dual.d116).reshape(1))
    ...
    prob.constraints[122].save_dual_value(np.array(res.cpg_dual.d122).reshape((1, 1), order='F'))
    prob.constraints[123].save_dual_value(np.array(res.cpg_dual.d123).reshape(1))
    prob.constraints[124].save_dual_value(np.array(res.cpg_dual.d124).reshape(1))
    ...
    prob.constraints[132].save_dual_value(np.array(res.cpg_dual.d132).reshape(1))
    ...
    prob.constraints[140].save_dual_value(np.array(res.cpg_dual.d140).reshape(1))
    ...
    prob.constraints[148].save_dual_value(np.array(res.cpg_dual.d148).reshape(1))
    ...
    prob.constraints[156].save_dual_value(np.array(res.cpg_dual.d156).reshape(1))
    ...
    prob.constraints[164].save_dual_value(np.array(res.cpg_dual.d164).reshape(1))
    ...
    prob.constraints[172].save_dual_value(np.array(res.cpg_dual.d172).reshape(1))
    ...
    prob.constraints[180].save_dual_value(np.array(res.cpg_dual.d180).reshape(1))
    ...
    prob.constraints[188].save_dual_value(np.array(res.cpg_dual.d188).reshape(1))
    ...
    prob.constraints[196].save_dual_value(np.array(res.cpg_dual.d196).reshape(1))
    ...
    prob.constraints[204].save_dual_value(np.array(res.cpg_dual.d204).reshape(1))
    ...
    prob.constraints[212].save_dual_value(np.array(res.cpg_dual.d212).reshape(1))
    ...
    prob.constraints[220].save_dual_value(np.array(res.cpg_dual.d220).reshape(1))
    ...
    prob.constraints[228].save_dual_value(np.array(res.cpg_dual.d228).reshape(1))
    ...
    prob.constraints[236].save_dual_value(np.array(res.cpg_dual.d236).reshape(1))
    ...
    prob.constraints[244].save_dual_value(np.array(res.cpg_dual.d244).reshape(1))
    ...
    prob.constraints[247].save_dual_value(np.array(res.cpg_dual.d247).reshape((14, 1), order='F'))
    prob.constraints[248].save_dual_value(np.array(res.cpg_dual.d248).reshape((14, 1), order='F'))
    prob.constraints[249].save_dual_value(np.array(res.cpg_dual.d249).reshape((14, 1), order='F'))
    prob.constraints[250].save_dual_value(np.array(res.cpg_dual.d250).reshape((14, 1), order='F'))
    prob.constraints[251].save_dual_value(np.array(res.cpg_dual.d251).reshape((14, 1), order='F'))
    prob.constraints[252].save_dual_value(np.array(res.cpg_dual.d252).reshape((14, 1), order='F'))
    prob.constraints[253].save_dual_value(np.array(res.cpg_dual.d253).reshape((14, 1), order='F'))
    prob.constraints[254].save_dual_value(np.array(res.cpg_dual.d254).reshape((14, 1), order='F'))
    prob.constraints[255].save_dual_value(np.array(res.cpg_dual.d255).reshape((14, 1), order='F'))
    prob.constraints[256].save_dual_value(np.array(res.cpg_dual.d256).reshape((14, 1), order='F'))
    prob.constraints[257].save_dual_value(np.array(res.cpg_dual.d257).reshape((14, 1), order='F'))
    prob.constraints[258].save_dual_value(np.array(res.cpg_dual.d258).reshape((14, 1), order='F'))
    prob.constraints[259].save_dual_value(np.array(res.cpg_dual.d259).reshape((14, 1), order='F'))
    prob.constraints[260].save_dual_value(np.array(res.cpg_dual.d260).reshape((14, 1), order='F'))
    prob.constraints[261].save_dual_value(np.array(res.cpg_dual.d261).reshape((14, 1), order='F'))
    prob.constraints[262].save_dual_value(np.array(res.cpg_dual.d262).reshape((14, 1), order='F'))
    prob.constraints[263].save_dual_value(np.array(res.cpg_dual.d263).reshape((14, 1), order='F'))
    prob.constraints[264].save_dual_value(np.array(res.cpg_dual.d264).reshape((14, 1), order='F'))
    prob.constraints[265].save_dual_value(np.array(res.cpg_dual.d265).reshape((14, 1), order='F'))
    prob.constraints[266].save_dual_value(np.array(res.cpg_dual.d266).reshape((14, 1), order='F'))
    prob.constraints[267].save_dual_value(np.array(res.cpg_dual.d267).reshape((14, 1), order='F'))
    prob.constraints[268].save_dual_value(np.array(res.cpg_dual.d268).reshape((14, 1), order='F'))
    prob.constraints[269].save_dual_value(np.array(res.cpg_dual.d269).reshape((14, 1), order='F'))
    prob.constraints[270].save_dual_value(np.array(res.cpg_dual.d270).reshape((14, 1), order='F'))
    prob.constraints[271].save_dual_value(np.array(res.cpg_dual.d271).reshape((14, 1), order='F'))
    prob.constraints[272].save_dual_value(np.array(res.cpg_dual.d272).reshape((14, 1), order='F'))
    prob.constraints[273].save_dual_value(np.array(res.cpg_dual.d273).reshape((14, 1), order='F'))
    prob.constraints[274].save_dual_value(np.array(res.cpg_dual.d274).reshape((14, 1), order='F'))
    prob.constraints[275].save_dual_value(np.array(res.cpg_dual.d275).reshape((14, 1), order='F'))
...
def cpg_gradient(prob, gradient_sol_primal=None, gradient_sol_dual=None):
    ...
    gradient_sol = cpg_module.scp_socp__cpg_gsol()
    if gradient_sol_primal is not None and gradient_sol_dual is not None:
        ...
        gradient_sol.primal = [0] * 1339
        gradient_sol.dual = [0] * 2761
        use_sol = False

    # set variable deltas
    vdelta = cpg_module.scp_socp__cpg_vdelta()
    ...
    prob.param_dict['param7'].gradient = np.array(pdelta.param7).reshape((14, 30), order='F')
    prob.param_dict['param18'].gradient = np.array(pdelta.param18)
    prob.param_dict['param20'].gradient = np.array(pdelta.param20)
    prob.param_dict['param8'].gradient = np.array(pdelta.param8).reshape((3, 30), order='F')
    prob.param_dict['param19'].gradient = np.array(pdelta.param19)
    prob.param_dict['param21'].gradient = np.array(pdelta.param21)
    prob.param_dict['param9'].gradient = np.array(pdelta.param9)
    prob.param_dict['param10'].gradient = np.array(pdelta.param10).reshape((14, 406), order='F')
    prob.param_dict['param11'].gradient = np.array(pdelta.param11).reshape((14, 87), order='F')
    prob.param_dict['param12'].gradient = np.array(pdelta.param12).reshape((14, 87), order='F')
    prob.param_dict['param13'].gradient = np.array(pdelta.param13).reshape((14, 29), order='F')
    prob.param_dict['param14'].gradient = np.array(pdelta.param14).reshape((14, 29), order='F')
