...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["param3972", "param3966", "param3967", "param3969", "param3970", "param3971", "param3968"]
    ...
    par.param3971 = list(param_dict["param3971"].value.flatten(order="F"))
    ...
    prob.var_dict['var3965'].save_value(np.array(res.cpg_prim.var3965).reshape(34))
    ...
    prob.constraints[16].save_dual_value(np.array(res.cpg_dual.d16).reshape(14))
    ...
    prob.constraints[26].save_dual_value(np.array(res.cpg_dual.d26).reshape(14))
    ...
    prob.constraints[31].save_dual_value(np.array(res.cpg_dual.d31).reshape(14))
    ...
    prob.constraints[36].save_dual_value(np.array(res.cpg_dual.d36).reshape(14))
    ...
    prob.constraints[46].save_dual_value(np.array(res.cpg_dual.d46).reshape(14))
    ...
    prob.constraints[51].save_dual_value(np.array(res.cpg_dual.d51).reshape(14))
    ...
    prob.constraints[56].save_dual_value(np.array(res.cpg_dual.d56).reshape(14))
    ...
    prob.constraints[66].save_dual_value(np.array(res.cpg_dual.d66).reshape(14))
    ...
    prob.constraints[71].save_dual_value(np.array(res.cpg_dual.d71).reshape(14))
    ...
    prob.constraints[76].save_dual_value(np.array(res.cpg_dual.d76).reshape(14))
    ...
    prob.constraints[86].save_dual_value(np.array(res.cpg_dual.d86).reshape(14))
    ...
    prob.constraints[91].save_dual_value(np.array(res.cpg_dual.d91).reshape(14))
    ...
    prob.constraints[96].save_dual_value(np.array(res.cpg_dual.d96).reshape(14))
    ...
    prob.constraints[106].save_dual_value(np.array(res.cpg_dual.d106).reshape(14))
    ...
    prob.constraints[111].save_dual_value(np.array(res.cpg_dual.d111).reshape(14))
    ...
    prob.constraints[116].save_dual_value(np.array(res.cpg_dual.d116).reshape(14))
    ...
    prob.constraints[126].save_dual_value(np.array(res.cpg_dual.d126).reshape(14))
    ...
    prob.constraints[131].save_dual_value(np.array(res.cpg_dual.d131).reshape(14))
    ...
    prob.constraints[136].save_dual_value(np.array(res.cpg_dual.d136).reshape(14))
    ...
    prob.constraints[141].save_dual_value(np.array(res.cpg_dual.d141).reshape(14))
    ...
    prob.constraints[146].save_dual_value(np.array(res.cpg_dual.d146).reshape(14))
    ...
    prob.constraints[151].save_dual_value(np.array(res.cpg_dual.d151).reshape(14))
    ...
    prob.constraints[156].save_dual_value(np.array(res.cpg_dual.d156).reshape(14))
    ...
    prob.constraints[161].save_dual_value(np.array(res.cpg_dual.d161).reshape(14))
    ...
    prob.constraints[166].save_dual_value(np.array(res.cpg_dual.d166).reshape(14))
...
def cpg_gradient(prob, gradient_sol_primal=None, gradient_sol_dual=None):
    ...
    vdelta.var3965 = list(prob.var_dict["var3965"].gradient.flatten(order="F"))
    ...
    prob.param_dict['param3966'].gradient = np.array(pdelta.param3966).reshape(14)
    prob.param_dict['param3967'].gradient = np.array(pdelta.param3967).reshape((14, 35), order='F')
    ...
    prob.param_dict['param3971'].gradient = np.array(pdelta.param3971).reshape((14, 34), order='F')
    prob.param_dict['param3968'].gradient = np.array(pdelta.param3968).reshape((3, 34), order='F')
