...
// Primal solution
typedef struct {
  cpg_float    *var3963;   // Your variable var3963
  cpg_float    *var3964;   // Your variable var3964
  cpg_float    *var3965;   // Your variable var3965
} CPG_Prim_t;
...
// Parameter deltas
typedef struct {
  cpg_float    *param3972;   // Delta of your parameter param3972
  cpg_float    *param3966;   // Delta of your parameter param3966
  cpg_float    *param3967;   // Delta of your parameter param3967
  cpg_float    *param3969;   // Delta of your parameter param3969
  cpg_float    *param3970;   // Delta of your parameter param3970
  cpg_float    *param3971;   // Delta of your parameter param3971
  cpg_float    *param3968;   // Delta of your parameter param3968
} CPG_Delta_t;
...
extern cpg_float mpc_socp__cpg_params_vec[9651];

// Sparse mappings from user-defined to canonical parameters
extern cpg_csc mpc_socp__canon_A_map;
extern cpg_csc mpc_socp__canon_b_map;
extern cpg_csc mpc_socp__canon_h_map;

// Canonical parameters
extern cpg_csc mpc_socp__canon_P;
extern cpg_csc mpc_socp__canon_P_conditioning;
extern cpg_float mpc_socp__canon_c[1272];
extern cpg_float mpc_socp__canon_c_conditioning[1272];
extern cpg_csc mpc_socp__canon_A;
extern cpg_csc mpc_socp__canon_A_conditioning;
extern cpg_float mpc_socp__canon_b[1068];
extern cpg_float mpc_socp__canon_b_conditioning[1068];
extern cpg_csc mpc_socp__canon_G;
extern cpg_csc mpc_socp__canon_G_conditioning;
extern cpg_float mpc_socp__canon_h[408];
extern cpg_float mpc_socp__canon_h_conditioning[408];

// Struct containing canonical parameters
extern Canon_Params_t mpc_socp__Canon_Params;
extern Canon_Params_t mpc_socp__Canon_Params_conditioning;

// Struct containing flags for outdated canonical parameters
extern Canon_Outdated_t mpc_socp__Canon_Outdated;

// User-defined variables
extern cpg_float mpc_socp__cpg_var3963[490];
extern cpg_float mpc_socp__cpg_var3964[102];
extern cpg_float mpc_socp__cpg_var3965[34];

// Dual variables associated with user-defined constraints
extern cpg_float mpc_socp__cpg_d0[14];
extern cpg_float mpc_socp__cpg_d1[14];
extern cpg_float mpc_socp__cpg_d6[14];
extern cpg_float mpc_socp__cpg_d11[14];
extern cpg_float mpc_socp__cpg_d16[14];
extern cpg_float mpc_socp__cpg_d21[14];
extern cpg_float mpc_socp__cpg_d26[14];
extern cpg_float mpc_socp__cpg_d31[14];
extern cpg_float mpc_socp__cpg_d36[14];
extern cpg_float mpc_socp__cpg_d41[14];
extern cpg_float mpc_socp__cpg_d46[14];
extern cpg_float mpc_socp__cpg_d51[14];
extern cpg_float mpc_socp__cpg_d56[14];
extern cpg_float mpc_socp__cpg_d61[14];
extern cpg_float mpc_socp__cpg_d66[14];
extern cpg_float mpc_socp__cpg_d71[14];
extern cpg_float mpc_socp__cpg_d76[14];
extern cpg_float mpc_socp__cpg_d81[14];
extern cpg_float mpc_socp__cpg_d86[14];
extern cpg_float mpc_socp__cpg_d91[14];
extern cpg_float mpc_socp__cpg_d96[14];
extern cpg_float mpc_socp__cpg_d101[14];
extern cpg_float mpc_socp__cpg_d106[14];
extern cpg_float mpc_socp__cpg_d111[14];
extern cpg_float mpc_socp__cpg_d116[14];
extern cpg_float mpc_socp__cpg_d121[14];
extern cpg_float mpc_socp__cpg_d126[14];
extern cpg_float mpc_socp__cpg_d131[14];
extern cpg_float mpc_socp__cpg_d136[14];
extern cpg_float mpc_socp__cpg_d141[14];
extern cpg_float mpc_socp__cpg_d146[14];
extern cpg_float mpc_socp__cpg_d151[14];
extern cpg_float mpc_socp__cpg_d156[14];
extern cpg_float mpc_socp__cpg_d161[14];
extern cpg_float mpc_socp__cpg_d166[14];

// Struct containing primal solution
extern CPG_Prim_t mpc_socp__CPG_Prim;

// Struct containing dual solution
extern CPG_Dual_t mpc_socp__CPG_Dual;

// Struct containing solver info
extern CPG_Info_t mpc_socp__CPG_Info;

// Struct containing solution and info
extern CPG_Result_t mpc_socp__CPG_Result;

// Struct containing solver settings
extern Canon_Settings_t mpc_socp__Canon_Settings;

// QOCO array of SOC dimensions
extern cpg_int mpc_socp__qoco_q[68];

// QOCO workspace
extern QOCOSolver* mpc_socp__qoco_solver;

// QOCO exit flag
extern cpg_int mpc_socp__qoco_flag;
